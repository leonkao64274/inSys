...
<div id="sitemesh-header">
    <spring:message text="" code="ui.cek"/><!--內容加密金鑰設定-->
</div>

<!-- page content -->
<div id="sitemesh-content">
    <form:form id="form1" action="#" method="POST" modelAttribute="cekCriteriaForm">
        <!-- 錯誤訊息區 -->
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group ${status.error ? 'has-error' : ''}">
									<label class="control-label">
										<spring:message text="" code="ui.cek.key-alias"/><!--金鑰基碼識別-->
									</label>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group ${status.error ? 'has-error' : ''}">
									<label class="control-label">
										<spring:message text="" code="ui.cek.status"/><!--啟用狀態-->
									</label>
									<form:select class="form-control" path="criteriaStatus">
										...
										<form:option value="1">
											<spring:message text="" code="ui.cek.status-enabled"/><!--啟用-->
										</form:option>
										<form:option value="0">
											<spring:message text="" code="ui.cek.status-disabled"/><!--未啟用-->
										</form:option>
									</form:select>
                    ...
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr class="bg-primary">
                            	...
                            	<th class="text-nowrap">
                            		<spring:message text="" code="ui.cek.alg" /><!-- 演算法 -->
                            	</th>
                            	<th class="text-nowrap">
                            		<spring:message text="" code="ui.cek.key-size" /><!-- 金鑰長度 -->
                            	</th>
                            	<th class="text-nowrap">
                            		<spring:message text="" code="ui.cek.kek-key-alias" /><!-- 金鑰加密金鑰 -->
                            	</th>
                            	<th class="text-nowrap">
                            		<spring:message text="" code="ui.cek.modify-time" /><!-- 異動時間 -->
                            	</th>
                            	<th class="text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><c:out value="${kmsInfo.kekKeyAlias}" /></td>
                                <td>
