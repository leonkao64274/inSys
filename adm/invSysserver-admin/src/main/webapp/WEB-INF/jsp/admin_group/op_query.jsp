...
<div id="sitemesh-header">
	<spring:message code="ui.admin-group.query" /><!-- 群組查詢 -->
</div>
...
<div id="sitemesh-content">
	<form:form id="form1" action="#" method="POST" modelAttribute="adminGroupCriteriaForm">
					...
					<table class="table table-striped table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="./op_detail?oid=<c:out value="${adminGroup.oid}"/>" class="btn btn-sm btn-default"><spring:message code="btn.detail" /><!--明細--></a>
								</td>
							</tr>
							</c:forEach>
						</tbody>
		...
		<c:if test="${not empty queryResult.content}">
			<admin:PaginatorTagHandler formId="form1" pagingUri="./op_query" page="${queryResult}" />
		</c:if>
	</form:form>
</div>
