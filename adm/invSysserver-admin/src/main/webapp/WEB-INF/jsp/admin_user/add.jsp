			...
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-heading">
						<spring:message code="ui.admin-user.data.add" /><!--使用者資料-新增-->
					</div>
					...
					<div class="panel-body">
							...
							<div class="col-md-6">
								<spring:bind path="account">
									<div class="form-group ${status.error ? 'has-error' : ''}">
										...
										<form:input path="account" class="form-control" maxlength="20" />
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="form-group ${status.error ? 'has-error' : ''}">
									<label class="control-label"> 
										<spring:message code="ui.admin-user.password" />${req}<!-- 密碼(*) -->
									</label>
									<form:password path="password" class="form-control" maxlength="12" 
											id="password" />
							...
							<div class="col-md-6">
								<!-- 注意：無需綁定。-->
								<spring:bind path="cnfrPassword">
								<div class="form-group ${status.error ? 'has-error' : ''}" id="password-column">
									<label class="control-label"> 
										<spring:message code="ui.admin-user.cnfrpassword" />${req}<!-- 確認密碼(*) -->
									</label>
								<form:password path="cnfrPassword" id="cnfrPassword" cssClass="form-control" maxlength="12" />
								<form:errors path="cnfrPassword" />
								</div>
								</spring:bind>
							</div>
						</div>
