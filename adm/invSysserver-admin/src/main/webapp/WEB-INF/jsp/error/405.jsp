...
<link
	href="${pageContext.request.contextPath}/vendor/bootstrap/css/bootstrap-datetimepicker.css"
	rel="stylesheet">
...
<link href="${pageContext.request.contextPath}/css/invSetPay.css"
	rel="stylesheet" type="text/css">
			...
			<div class="inner">
				<div class="row">
					<div class="col-lg-6 col-lg-offset-3">
						...
						<h4 class="error-msg">
							<i class="fa fa-warning text-red"></i> Method not allowed
						</h4>
						<p class="lead">
							<spring:message text="" code="ui.ERR_405" />
						</p>
