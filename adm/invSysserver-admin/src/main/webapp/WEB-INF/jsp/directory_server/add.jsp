			...
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<spring:message code="ui.directory-server.add" text="" />
					</div>
										...
										<spring:bind path="proxyEnabled">
											<div class="form-group ${status.error ? 'has-error' : ''}">
                                                ...
                                                <div>
                                                    ...
                                                    <label class="radio-inline"><form:radiobutton path="proxyEnabled" value="0" checked="true"/><spring:message text="不啟用" code="ui.directory-server.disabled"/><!-- 不啟用 --></label>
                                                </div>
...
<!--
									<a href="./query" id="btnSubmit" class="btn btn-primary">
